...
from dataset_loaders.colmap_loader import read_extrinsics_text, read_intrinsics_text, qvec2rotmat, \
...
def readColmapCameras(cam_extrinsics, cam_intrinsics, images_folder):
    cam_infos = []
    for idx, key in enumerate(tqdm(cam_extrinsics, desc="Reading Cameras")):
        ...
        cam_info = CameraInfo(uid=uid, R=R, T=T, FovY=FovY, FovX=FovX, fx=focal_length_x, fy=focal_length_y,
